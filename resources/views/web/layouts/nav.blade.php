  ...
  <header id="header" class="fixed-top " style="background: rgba(0, 0, 0, 0.8);">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto {{ Route::is('index')  ? 'active' : '' }}" href="{{route('virtualTour')}}#features">Virtual Tour</a></li>
          <li><a class="nav-link scrollto {{ Route::is('memberForm')  ? 'active' : ''}}" href="{{route('memberForm')}}">Member Info Form</a></li>
        </ul>
