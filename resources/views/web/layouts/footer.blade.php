<footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>CECL<span>.</span></h3>
              <p>
                Ardent Tower, 9 Rd No 113/A  <br>
                Dhaka 1212<br><br>
                <strong>Phone:</strong> +880 <br>
                <strong>Email:</strong> info@cecl.com<br>
              </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>CECL</span></strong>  All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://codershub.codes/">codershub</a>
      </div>
    </div>
  </footer><!-- End Footer -->
